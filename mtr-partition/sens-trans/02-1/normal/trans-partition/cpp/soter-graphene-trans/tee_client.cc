...
struct trans : public torch::nn::Module
{
    ...
    trans():
        ...
        fc311(d_ff, d_model)      
        {
            ...
            forwards.push_back(std::bind(&trans::forward3_new, this, std::placeholders::_1));
            forwards.push_back(std::bind(&trans::forward4_new, this, std::placeholders::_1));
        }
    ...
    torch::Tensor forward3_new(torch::Tensor src) {
        // std::cout<<"forward1_new"<<std::endl;
        int nbatches;
        torch::Tensor temp;
        torch::Tensor temp0;
        ...
        // std::cout << "forward3_new"<<std::endl;
        src0 = src;
        nbatches = src0.size(0);
        ...
        temp1 = temp.view( {nbatches, -1, nheads, d_k} ).transpose(1, 2);
        // std::cout << "2"<<std::endl;
        temp = fc21.forward(med);
        temp0 = fc21.forward(med);
        temp1 = fc21.forward(med);
        temp2 = fc21.forward(med);
        temp3 = fc21.forward(med);
        // std::cout << "3"<<std::endl;
        temp2 = temp.view( {nbatches, -1, nheads, d_k} ).transpose(1, 2);
        temp4 = fc21.forward(med);
        temp5 = fc21.forward(med);
        temp6 = fc21.forward(med);
// std::cout << "4"<<std::endl;
        return temp2;
    }
    torch::Tensor forward4_new(torch::Tensor src) {
        int nbatches;
        torch::Tensor temp;
        torch::Tensor temp0;
        torch::Tensor temp1;
