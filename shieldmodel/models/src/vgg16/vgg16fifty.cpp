...
struct part2 : public torch::nn::Module
{
    ...
    {
        auto x = F::max_pool2d(F::relu(C15(F::relu(C13(F::relu(C11(input)))))), F::MaxPool2dFuncOptions(2));
        return x;
    }
};
...
struct part3 : public torch::nn::Module
{
    ...
    {
        auto x = F::relu(C20(F::relu(C18(input))));
        return x;
    }
};
...
struct part4 : public torch::nn::Module
{
    ...
    {
        auto x = F::max_pool2d(F::relu(C22(input)), F::MaxPool2dFuncOptions(2));
        return x;
    }
};
...
struct part5 : public torch::nn::Module
{
    ...
    {
        auto x = F::relu(C27(F::relu(C25(input))));
        return x;
    }
};
...
struct part6 : public torch::nn::Module
{
    ...
    {
        auto x = F::max_pool2d(F::relu(C29(input)), F::MaxPool2dFuncOptions(2));
...
int main()
{
    std::cout << "vgg16 - 50% outsourced to CUDA version." << std::endl;
    vgg16_fifty_split model;
